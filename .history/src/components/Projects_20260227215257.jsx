...
const projects = [
  ...
  {
  id: 8,
    title: "Three js moving particles",
          ...
          {projects.map((project, key) => (
            ...
            >
              ...
              <div className='text-left w-full mt-15 md:mt-2'>
                <h1 className='text-2xl font-bold bg-blue-700 text-white'>{project.title} <a href={project.href}><button className='bg-primary text-sm text-foreground mx-15 px-2 py- rounded hover:bg-blue-800 transition cursor-pointer mt-2'>Live</button></a></h1>
