  ...
  useEffect(()=>{
    ...
    function disturb(){
      const _position=sgeo.attributes.position;
            ...
            for(let i=0;i<_position.array.length;i++){
                _position.array[i*3]+=(_oposition[i*3]-_position.array[i*3])*0.01;
                _position.array[i*3+1]+=(_oposition[i*3+1]-_position.array[i*3+1])*0.02;
                _position.array[i*3+2]+=(_oposition[i*3+2]-_position.array[i*3+2])*0.01;
            }
